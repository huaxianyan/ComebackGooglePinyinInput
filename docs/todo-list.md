...
- [ ] `feat/target-sdk-35`：V2 broad system-window bottom inset 导致过大黑区且最高键盘仍可被遮挡；V3 已改为仅使用 `WindowInsets.Type.navigationBars()` 的精确 bottom inset 并覆盖安装，等待默认/最高键盘高度复测
