...
- [ ] 隔离验证修正版原生候选视觉：ART 类加载无 `VerifyError`、关闭按钮按退格/九键光标/语音参考键窗口坐标对齐真实右列中心、左右分隔线克隆原生展开键 divider 的 Drawable/tint/color filter 且紧跟短文本不重叠/不丢失、200dp 内保持原生字号并省略、关闭及展开箭头恢复
